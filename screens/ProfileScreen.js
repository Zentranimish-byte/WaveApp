    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.tilesRow}>
          <View style={styles.tile}><Text style={styles.tileLabel}>Music</Text><Text style={styles.tileText}>Hip-Hop / Indie</Text></View>
          <View style={styles.tile}><Text style={styles.tileLabel}>Food</Text><Text style={styles.tileText}>Spicy defender</Text></View>
        </View>
        <View style={styles.tilesRow}>
          <View style={styles.tile}><Text style={styles.tileLabel}>Night</Text><Text style={styles.tileText}>Night owl</Text></View>
          <View style={styles.tile}><Text style={styles.tileLabel}>Vibe</Text><Text style={styles.tileText}>Chaotic</Text></View>
        </View>
        <View style={styles.tilesRow}>
          <View style={styles.tile}><Text style={styles.tileLabel}>Here for</Text><Text style={styles.tileText}>Just vibing</Text></View>
          <View style={styles.tile}><Text style={styles.tileLabel}>Drinks</Text><Text style={styles.tileText}>Sometimes</Text></View>
        </View>
      </ScrollView>
    </View>
  );
